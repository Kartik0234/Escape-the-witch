...
function draw() {
  ...
  if(gamestate === "play")
  {
    ...
    {
      witchMovement()
      var bar = createSprite(b.x,b.y,30,30)
      bar.shapeColor="red"
      b.depth = bar.depth+1
      barriersGroup.add(bar)
...
function witchMovement()
{
  ...
  if(b.x>=140 && b.y>=75 && b.x<=160 && b.y<=95 )
  {
    b.velocityX=0;
    b.velocityY=vy;
  }

  if(b.x>=140 && b.y>=227 && b.x<=160 && b.y<=235 )
  {
    b.velocityX=-1*vx;
    b.velocityY=0;
  }

  if(b.x>=66 && b.y>=227 && b.x<=75 && b.y<=235 )
  {
    b.velocityX=0;
    b.velocityY=vy;
  }

  if(b.x>=74 && b.y>=447 && b.x<=80 && b.y<=452 )
  {
    b.velocityX=vx;
    b.velocityY=0;
  }

  if(b.x>=180 && b.y>=447 && b.x<=190 && b.y<=452 )
  {
    b.velocityX=0;
    b.velocityY=-1*vy;
  }

  if(b.x<=180 && b.y<=375 && b.x>=170 && b.y>=370 )
  {
    b.velocityX=-1*vx;
    b.velocityY=0;
  }

  if(b.x<=120 && b.y<=375 && b.x>=110 && b.y>=370 )
  {
    b.velocityX=0;
    b.velocityY=-1*vy;
  }
  ...
  if(b.x>=120 && b.y>=275 && b.x<=130 && b.y<=282 )
  {
    b.velocityX=vx;
    b.velocityY=0;
  }
  ...
  if(b.x>=240 && b.y>=280 && b.x<=245 && b.y<=285 )
  {
    b.velocityX=0;
    b.velocityY=-1*vy;
  }
  ...
  if(b.x>=240 && b.y>=180 && b.x<=250 && b.y<=185 )
  {
    b.velocityX=vx;
    b.velocityY=0;
  }
  ...
  if(b.x>=372 && b.y>=185 && b.x<=375 && b.y<=190 )
  {
    b.velocityX=0;
    b.velocityY=-1*vy;
  }
  ...
  if(b.x>=370 && b.y>=100 && b.x<=375 && b.y<=105 )
  {
    b.velocityX=vx;
    b.velocityY=0;
  }
  ...
  if(b.x>=465 && b.y>=105 && b.x<=470 && b.y<=110 )
  {
    b.velocityX=0;
    b.velocityY=vy;
  }
  ...
  if(b.x>=465 && b.y>=240 && b.x<=470 && b.y<=245 )
  {
    b.velocityX=-1*vx;
    b.velocityY=0;
  }
  ...
  if(b.x<=360 && b.y>=240 && b.x>=350 && b.y<=245 )
  {
    b.velocityX=0;
    b.velocityY=vy;
  }
  ...
  if(b.x>=360 && b.y>=405 && b.x<=365 && b.y<=410 )
  {
    b.velocityX=-1*vx;
    b.velocityY=0;
  }
  ...
  if(b.x<=310 && b.y>=405 && b.x>=305 && b.y<=410 )
  {
    b.velocityX=0;
    b.velocityY=vy;
  }
  ...
  if(b.x>=310 && b.y>=575 && b.x<=315 && b.y<=580 )
  {
    b.velocityX=vx;
    b.velocityY=0;
  }
  ...
  if(b.x>=425 && b.y>=575 && b.x<=430 && b.y<=580 )
  {
    b.velocityX=0;
    b.velocityY=-1*vy;
  }
  if(b.x>=425 && b.y>=525 && b.x<=430 && b.y<=530 )
  {
    b.velocityX=vx;
    b.velocityY=0;
  }
